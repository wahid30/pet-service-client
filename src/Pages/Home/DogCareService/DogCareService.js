      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-12">
          ...
          <div className="flex flex-col gap-2 p-5 rounded-2xl text-center bg-gradient-to-r from-sky-500 to-indigo-500 text-white">
            ...
            <span className="">(281 809-7748)</span>
            <span className="">(281)715-4029(Fax)</span>
          </div>
          {/* 002  */}
          <div className="flex flex-col gap-2 p-5 rounded-2xl text-center bg-gradient-to-r from-sky-500 to-indigo-500 text-white">
            <h1 className="text-2xl font-semibold">Hours of Operation</h1>
            <span className="">Monday-Friday: 7 a.m. - 7p.m</span>
            <span className="">Saturday: 9 a.m.-6 p.m.</span>
            <span className="">Sunday: 10 a.m.-6 p.m.</span>
          </div>
          {/* 003  */}
          <div className="flex flex-col gap-2 p-5 rounded-2xl text-center bg-gradient-to-r from-sky-500 to-indigo-500 text-white">
            <h1 className="text-2xl font-semibold">Check Out Times</h1>
            <span className="">Monday-Sunday: 1 p.m</span>
          </div>
          {/* 004  */}
          <div className="flex flex-col gap-2 p-5 rounded-2xl text-center bg-gradient-to-r from-sky-500 to-indigo-500 text-white">
            <h1 className="text-2xl font-semibold">Address</h1>
            <span className="">9040 Highway 6 N Houston, TX 77095-2303</span>
          </div>
          {/* 005  */}
          <div className="flex flex-col gap-2 p-5 rounded-2xl text-center bg-gradient-to-r from-sky-500 to-indigo-500 text-white">
